...
<div id="carouselExampleControls" class="carousel slide bs-slider box-slider" data-ride="carousel" data-pause="hover" data-interval="false" >
		...
		<div class="carousel-inner" role="listbox">
			<div class="carousel-item active">
				<div id="home" class="first-section" style="background-image:url({{url('Home/images/kantor-01.jpg')}});">
					<div class="dtab">
						<div class="container">
							<div class="row">
								<div class="col-md-12 col-sm-12 text-right">
									<div class="big-tagline">
										<h2><strong>&nbsp;E-Aset </strong>Kabupaten Bandung</h2>
										<p class="lead">Kantor dinas Kabupaten Bandung </p>
									</div>
								</div>
							</div><!-- end row -->            
						</div><!-- end container -->
    ...
    <div id="overviews" class="section wb">
        <div class="container">
			...
			<div class="row align-items-center">
				<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                    <div class="post-media wow fadeIn">
                        <img src="{{URL::to('Home/images/about_03.jpg')}}" alt="" class="img-fluid img-rounded">
                    </div><!-- end media -->
                </div><!-- end col -->
